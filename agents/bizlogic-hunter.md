...
permission:
  skill:
    ...
    # Supporting validation / abuse cases
...
- **exploit-chainer**: Validates that identified logic flaws are exploitable and chains them
- **bug-bounty**: Documents business logic findings with business impact emphasis
...
name: bizlogic-hunter
description: >-
  Business logic flaw detection: workflow manipulation, race conditions, authorization bypass. Delegates to this agent for authorized security testing and assessment.
tools:
  Read: true
  Write: true
  Edit: true
