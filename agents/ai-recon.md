...
name: ai-recon
description: >-
  AI-assisted reconnaissance: target enumeration, attack surface mapping. Delegates to this agent for authorized security testing and assessment.
tools:
  Read: true
  Write: true
  Edit: true
