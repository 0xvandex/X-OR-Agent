...
permission:
  skill:
    ...
    # Core vulnerability scanning / assessment
    "security-arsenal": "allow"
    "recon": "allow"
    "recon-scope-triage": "allow"
    "web": "allow"
    "api": "allow"
    ...
    "fuzzing": "allow"
    "hunt-api-misconfig": "allow"
    "hunt-cloud-misconfig": "allow"
    "hunt-source-leak": "allow"
    "hunt-subdomain": "allow"
    "hunt-tls-network": "allow"
    "hunt-ntlm-info": "allow"
    "hunt-exceptional-conditions": "allow"
    ...
    "hunt-cors": "allow"
    "hunt-csrf": "allow"
    "hunt-open-redirect": "allow"
    "hunt-http-smuggling": "allow"
    "hunt-host-header": "allow"
    "hunt-clickjacking": "allow"
    "hunt-dom": "allow"
    "hunt-session": "allow"
    "hunt-oauth": "allow"
    "hunt-jwt-crypto": "allow"
    "hunt-race-condition": "allow"
    "hunt-business-logic": "allow"
    "hunt-websocket": "allow"

    # API / modern application scanning
    "graphql-audit": "allow"
    "hunt-graphql": "allow"
    "hunt-grpc": "allow"
    "hunt-shadow-api": "allow"
    "hunt-spa-api": "allow"
    "hunt-rag-vector": "allow"

    # Infrastructure / enterprise scanning
    ...
    # Supporting validation / exploitation context
    "exploit-dev": "allow"
    "privesc": "allow"
    "post-exploitation": "allow"
    "credential-attack": "allow"

    # Evidence / validation / detection
...
name: vuln-scanner
description: >-
  Vulnerability scanning: nuclei templates, nikto, automated vulnerability detection. Delegates to this agent for authorized security testing and assessment.
tools:
  Read: true
  Write: true
  Edit: true
