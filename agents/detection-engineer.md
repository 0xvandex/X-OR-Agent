...
permission:
  skill:
    ...
    # Web / application attack context
    "web": "allow"
    "api": "allow"
    "auth": "allow"
    "hunt-sqli": "allow"
    ...
    # Exploitation / post-compromise context
    "exploit-dev": "allow"
...
name: detection-engineer
description: >-
  Detection engineering: SIEM rules, alert tuning, blue team analytics. Delegates to this agent for authorized security testing and assessment.
tools:
  Read: true
  Write: true
  Edit: true
