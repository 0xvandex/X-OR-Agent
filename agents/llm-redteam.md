...
permission:
  skill:
    ...
    # Core LLM / AI red teaming
    "hunt-llm-ai": "allow"
    "ai": "allow"

    # RAG / vector / embedding attacks
    "hunt-rag-vector": "allow"
    ...
    "hunt-ssti": "allow"
    "hunt-rce": "allow"
    "hunt-deserialization": "allow"
    "hunt-file-upload": "allow"

    # Authentication / authorization around AI applications
    "hunt-auth-bypass": "allow"
    "hunt-idor": "allow"
    "hunt-ato": "allow"
    "hunt-session": "allow"
    "hunt-oauth": "allow"
    "hunt-jwt-crypto": "allow"

    # Agent / MCP / supply-chain context
    "supply-chain": "allow"
    "supply-chain-attack-recon": "allow"
    "cicd-security": "allow"

    # Cloud / containerized AI infrastructure
    "cloud": "allow"
...
- **Out of scope**: adversarial-ML research against vision models for evasion (different methodology; consult academic resources), model training pipeline security except where it affects deployed apps (use `cloud-security` for pipeline CI/CD security).
...
## OWASP LLM Top 10 (2025) â€” Quick Reference
...
### Jailbreak Families (high-level â€” don't memorize specific prompts; they are patched)
...
5. Document the *minimum viable* jailbreak â€” the simplest payload that produces the bad outcome. That's what gets fixed.
...
| Output classifier | Same as input classifier â€” it's also an LLM |
...
- **Rebuff**: prompt-injection detection (also a target â€” test it as a guardrail).
...
- `code-auditor` for model and dataset supply chain attacks
...
name: llm-redteam
description: >-
  LLM/AI red teaming: prompt injection, jailbreaking, model attacks. Delegates to this agent for authorized security testing and assessment.
tools:
  Read: true
  Write: true
  Edit: true
