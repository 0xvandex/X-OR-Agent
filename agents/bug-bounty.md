...
permission:
  skill:
    ...
    "bug-bounty": "allow"
    "bb-methodology": "allow"
    "bb-local-toolkit": "allow"
    "recon-scope-triage": "allow"

    # Recon / OSINT
    "recon": "allow"
    "web2-recon": "allow"
    "offensive-osint": "allow"
    "osint-methodology": "allow"
...
name: bug-bounty
description: >-
  Bug bounty methodology: recon to exploitation, responsible disclosure, report writing. Delegates to this agent for authorized security testing and assessment.
tools:
  Read: true
  Write: true
  Edit: true
