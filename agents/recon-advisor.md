...
permission:
  skill:
    ...
    # DNS / subdomain / exposed attack surface
...
name: recon-advisor
description: >-
  Network reconnaissance: nmap scanning, service enumeration, OS fingerprinting. Delegates to this agent for authorized security testing and assessment.
tools:
  Read: true
  Write: true
  Edit: true
