...
permission:
  skill:
    ...
    "hunt-mfa-bypass": "allow"
    "hunt-forgot-password": "allow"
    "hunt-brute-force": "allow"
    "hunt-captcha-bypass": "allow"
    "hunt-saml": "allow"
    ...
    # Supporting exploitation / testing
    "fuzzing": "allow"
    "exploit-dev": "allow"
    "security-arsenal": "allow"
    "web2-vuln-classes": "allow"
...
name: web-hunter
description: >-
  Web application penetration testing: directory brute forcing, SQL injection, XSS, hidden endpoints, parameter fuzzing. Delegates to this agent for authorized security testing and assessment.
tools:
  Read: true
  Write: true
  Edit: true
