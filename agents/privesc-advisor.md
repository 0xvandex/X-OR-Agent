...
permission:
  skill:
    ...
    # Vulnerability research / enumeration
    "fuzzing": "allow"
    "recon": "allow"
...
name: privesc-advisor
description: >-
  Privilege escalation: Linux/Windows/local enumeration, kernel exploits, misconfigs. Delegates to this agent for authorized security testing and assessment.
tools:
  Read: true
  Write: true
  Edit: true
