...
permission:
  skill:
    ...
    # CI/CD and cloud-native attack paths
    "cicd": "allow"
    "cicd-security": "allow"
    "hunt-cicd": "allow"

    # Network / exploitation support
    "network": "allow"
    "exploit-dev": "allow"
    "post-exploitation": "allow"
    "privesc": "allow"

    # Relevant cloud/web attack classes
    "hunt-ssrf": "allow"
...
name: cloud-security
description: >-
  Cloud security: AWS/Azure/GCP misconfigurations, IAM escalation. Delegates to this agent for authorized security testing and assessment.
tools:
  Read: true
  Write: true
  Edit: true
